...
class Marks:
    def __init__(self, CAT1=None, CAT2=None, SAT=None, End_sem=None):
        self.CAT1 = CAT1
        self.CAT2 = CAT2
        self.SAT = SAT
    ...
    def __str__(self):
        return str([self.CAT1, self.CAT2, self.SAT, self.End_sem])
...
class MenteeNode:
    ...
    def __init__(self, name, department, profile_picture=None, experience=None, skills=None, description=None,
                 ...
                 nationality=None, religion=None, community=None, remarks=None, marks=None):
        """
...
class Tree:
    ...
    def add_mentee(self, mentor_name, name, department,profile_picture=None,experience=None,  skills=None,
                   ...
                   dob=None, gender=None, nationality=None,):
        """
        ...
        if mentor:
            mentee = MenteeNode(name, department,profile_picture,experience ,skills,description,availability, 
                                contact_info, education, achievements, dob, gender, nationality,)
...
def running_status():
    ...
    tree.add_mentor("Gopal", "IT","None","10 years as Teacher","Communication","None","All time","Gopal@123","Btech IT Master in MBA Phd","Best teacher Award")
    tree.add_mentor("Heisenberg", "Chemical","None","10 years as teacher","Chess","None","All time","Heisenberg@123","BE chemical Master in MBA Phd","best Teacher Award")
    

    # Adding mentees to mentors
    tree.add_mentee("Gopal", "Anne", "IT","None","None","Karathe","None","all time","Anne@123","12 std","Black belt in karathe","22.01.2006","female","Indian")
    tree.add_mentee("Gopal", "Joe", "IT")
    tree.add_mentee("Heisenberg", "Prem", "CSE","None","none","Cricket","None","all time","Prem@123","12th std","Man of the match","10.09.2005","Male","Indian")
    ...
    tree.update_mentee_details(
        "Heisenberg", "Chelladurai", "contact_info", "Chelladurai@example.com")
